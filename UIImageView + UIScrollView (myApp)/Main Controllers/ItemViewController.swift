...
class ItemViewController: UIViewController, UIScrollViewDelegate {
    ...
    // добавляем линию (вью) вместо индикатора (такую же кастомную сделать не получилось)
    ...
    func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        // что-то из многопоточности, я пока не понимаю :), чтобы линия убиралась через 1 секунду (еще и с затуханием!)
